...
public:
  ...
  void amphour_remaining_sensor(sensor::Sensor *amphour_remaining_sensor) { amphour_remaining_sensor_ = amphour_remaining_sensor; }
...
protected:
  ...
  sensor::Sensor* amphour_remaining_sensor_{nullptr};
